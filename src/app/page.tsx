...
const Home: React.FC = () => {
  ...
  return (
    ...
    <div>
      <div 
          style={{ // rectangle for background of chatroom selection
        ...
        />
      <div 
          style={{ // rectangle for background of friends list
        ...
        />
        <div 
          style={{ // rectangle for background of info on the users
            width: '20.83vw',          // Width of the rectangle
            height: '100vh',         // Height of the rectangle
            backgroundColor: friendsBackgroundColor,  // Background color of the rectangle
            position: 'absolute',
        ...
        />
      <div 
          style={{ // rectangle for background of chat
